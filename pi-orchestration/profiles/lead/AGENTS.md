...
Paseo is the only delegation and agent-lifecycle plane. Never create provider-native agents. Runtime filesystem, shell, network, MCP, model, or full-access capability does not grant ownership, mutation, external-effect, recovery, or acceptance authority.
