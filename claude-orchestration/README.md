...
| Worker push/merge authority | PreToolUse trên `Bash`, dùng lại `gitAuthorityBlockReason` (`MODE: write`) |
...
test -f ~/.claude-paseo/lead/templates/TASK_BRIEF.md
```
