 ...
 *     PASEO_PI_ROLE).
 *   - Claude Code has NO `mcp` proxy tool and NO `mcp_script`. Paseo tools are
 ...
 *   - The supervisor create_agent gate requires a `claude-lead/<...>/<...>`
 *     successor (not pi-lead) and reads the tool args directly (Claude Code
...
/**
 * Claude Code passes create_agent params as the tool input directly. The Pi
